...
def run_demo(model, image_provider, height_size, cpu, track, smooth, file):
    ...
    for img in image_provider:
        ...
        cv2.imshow('Ligtweight Human Pose Estimation',img)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default='./video', help='path to video file or camera id')
